...
import app.katyaos.apps.core.DependencyResolutionException
import app.katyaos.apps.core.PackageState
import app.katyaos.apps.core.PkgInstallerStatusReceiver
import app.katyaos.apps.core.RPackage
import app.katyaos.apps.core.appContext
import app.katyaos.apps.core.getAllDependencies
import app.katyaos.apps.core.pkgInstaller
import app.katyaos.apps.core.pkgManager
import app.katyaos.apps.core.selfPkgName
import app.katyaos.apps.core.showMissingDependencyUi
import app.katyaos.apps.core.startPackageInstallFromUi
import app.katyaos.apps.databinding.DetailsScreenBinding
import app.katyaos.apps.databinding.PackageListItemBinding
import app.katyaos.apps.util.appDetailsIntent
import app.katyaos.apps.util.componentName
import app.katyaos.apps.util.getVersionNameOrVersionCode
import app.katyaos.apps.util.isSystemPackage
import app.katyaos.apps.util.isUpdatedSystemPackage
import app.katyaos.apps.util.maybeSetText
import app.katyaos.apps.util.setAvailable
