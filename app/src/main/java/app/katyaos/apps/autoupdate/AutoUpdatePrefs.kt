...
import app.katyaos.apps.ApplicationImpl.Companion.JOB_SCHEDULER_JOB_ID_AUTO_UPDATE
import app.katyaos.apps.ApplicationImpl.Companion.JOB_SCHEDULER_JOB_ID_UPDATE_CHECK
...
object AutoUpdatePrefs {
    ...
    fun maybeScheduleAutoUpdateJob() {
        ...
        val jobInfo = JobInfo.Builder(JOB_SCHEDULER_JOB_ID_AUTO_UPDATE, componentName<AutoUpdateJob>()).run {
            ...
            // installation, which can take over a minute on katyaOS due to the full AOT compilation.
