...
import app.katyaos.apps.core.InstallerSessions.abandonSession
import app.katyaos.apps.util.ScopedFileDescriptor
import app.katyaos.apps.util.checkMainThread
import app.katyaos.apps.util.copyTo2
import app.katyaos.apps.util.getPackageArchiveInfo
import app.katyaos.apps.util.getPackageInfoOrNull
import app.katyaos.apps.util.lseekToStart
import app.katyaos.apps.util.makeTemporaryFileDescriptor
import app.katyaos.apps.util.openConnection
import app.katyaos.apps.util.sendfile
import app.katyaos.apps.util.throwIfAppInstallationNotAllowed
import app.katyaos.apps.util.throwResponseCodeException
    ...
    companion object {
        ...
        suspend fun multiInstall(tasks: List<InstallTask>): Deferred<PackageInstallerError?> {
            ...
            val multiInstallAvailable = Build.VERSION.SDK_INT >= 33
                // confirmation UI for multi package sessions is broken before Android 13, fixed on katyaOS 12.1
