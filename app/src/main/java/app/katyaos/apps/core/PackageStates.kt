...
import app.katyaos.apps.core.InstallTask
import app.katyaos.apps.core.InstallerSessions
import app.katyaos.apps.core.InstallerSessions.installerSessionMap
import app.katyaos.apps.util.ActivityUtils
import app.katyaos.apps.util.checkMainThread
import app.katyaos.apps.util.forEachEntry
import app.katyaos.apps.util.getPackageInfoOrNull
import app.katyaos.apps.util.getSharedPreferences
import app.katyaos.apps.util.intent
import app.katyaos.apps.util.invokeOnCompletionOnMainThread
...
import app.katyaos.apps.core.RPackageContainer
import app.katyaos.apps.core.ReleaseChannel
import app.katyaos.apps.core.Repo
import app.katyaos.apps.core.RepoUpdateError
import app.katyaos.apps.core.fetchRepo
import app.katyaos.apps.core.getCachedRepo
import app.katyaos.apps.core.prunePackageCache
import app.katyaos.apps.util.getParcelableOrThrow
import app.katyaos.apps.util.simpleName
