...
import app.katyaos.apps.BuildConfig
import app.katyaos.apps.PackageStates
import app.katyaos.apps.R
import app.katyaos.apps.util.asStringList
import app.katyaos.apps.util.checkMainThread
import app.katyaos.apps.util.getPackageInfoOrNull
import app.katyaos.apps.util.isEven
import app.katyaos.apps.util.maybeGetSystemFeatureInfo
...
enum class PackageSource(@StringRes val uiName: Int) {
    katyaOS(R.string.pkg_source_katyaos),
    katyaOS_build(R.string.pkg_source_katyaos_build),
...
private fun shouldSkipRenamedPackages(): Boolean {
    ...
    return buildIncremental != null
            ...
            // See https://github.com/katyaOS/platform_frameworks_base/commit/3fd0aaea464535b683a231bd92627056c2e02518
