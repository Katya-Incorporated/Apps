...
import app.katyaos.apps.util.packageUri
...
fun startPackageInstall(pkg: RPackage, params: InstallParams,
    ...
    if (packagesToInstall.size == 1 && isPrivilegedInstaller && params.isUserInitiated
        ...
        if (pkgInfo != null && pkgInfo.isSystemPackage()) {
            ...
            // using the regular method will fail on katyaOS because update of a system package to
...
// See https://github.com/katyaOS/platform_frameworks_base, file
