...
enum class PackageSource(@StringRes val uiName: Int) {
    katyasystem(R.string.pkg_source_katyasystem),
    katyasystem_build(R.string.pkg_source_katyasystem_build),
                        ...
                        json: JSONObject)
{
    ...
    val source: PackageSource = (json.opt("source") as String?).let {
        if (it != null) {
            ...
            PackageSource.katyasystem_build
        }
    }
