package app.katyasystem.apps.core
...
import app.katyasystem.apps.core.InstallerSessions.abandonSession
import app.katyasystem.apps.util.ScopedFileDescriptor
import app.katyasystem.apps.util.checkMainThread
import app.katyasystem.apps.util.copyTo2
import app.katyasystem.apps.util.getPackageArchiveInfo
import app.katyasystem.apps.util.getPackageInfoOrNull
import app.katyasystem.apps.util.lseekToStart
import app.katyasystem.apps.util.makeTemporaryFileDescriptor
import app.katyasystem.apps.util.openConnection
import app.katyasystem.apps.util.sendfile
import app.katyasystem.apps.util.throwIfAppInstallationNotAllowed
import app.katyasystem.apps.util.throwResponseCodeException
    ...
    companion object {
        ...
        suspend fun multiInstall(tasks: List<InstallTask>): Deferred<PackageInstallerError?> {
            ...
            val multiInstallAvailable = Build.VERSION.SDK_INT >= 33
                // confirmation UI for multi package sessions is broken before Android 13, fixed on katyasystem 12.1
