...
import app.katyasystem.apps.core.pkgManager
import app.katyasystem.apps.core.InstallTask
import app.katyasystem.apps.core.InstallerSessions
import app.katyasystem.apps.core.InstallerSessions.installerSessionMap
import app.katyasystem.apps.util.ActivityUtils
import app.katyasystem.apps.util.checkMainThread
import app.katyasystem.apps.util.forEachEntry
import app.katyasystem.apps.util.getPackageInfoOrNull
import app.katyasystem.apps.util.getSharedPreferences
import app.katyasystem.apps.util.intent
import app.katyasystem.apps.util.invokeOnCompletionOnMainThread
...
import app.katyasystem.apps.core.PackageState
import app.katyasystem.apps.core.RPackageContainer
import app.katyasystem.apps.core.ReleaseChannel
import app.katyasystem.apps.core.Repo
import app.katyasystem.apps.core.RepoUpdateError
import app.katyasystem.apps.core.fetchRepo
import app.katyasystem.apps.core.getCachedRepo
import app.katyasystem.apps.core.prunePackageCache
import app.katyasystem.apps.util.getParcelableOrThrow
import app.katyasystem.apps.util.simpleName
