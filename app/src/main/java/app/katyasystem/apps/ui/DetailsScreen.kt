...
import app.katyasystem.apps.core.DependencyResolutionException
import app.katyasystem.apps.core.PackageState
import app.katyasystem.apps.core.PkgInstallerStatusReceiver
import app.katyasystem.apps.core.RPackage
import app.katyasystem.apps.core.appContext
import app.katyasystem.apps.core.getAllDependencies
import app.katyasystem.apps.core.pkgInstaller
import app.katyasystem.apps.core.pkgManager
import app.katyasystem.apps.core.selfPkgName
import app.katyasystem.apps.core.showMissingDependencyUi
import app.katyasystem.apps.core.startPackageInstallFromUi
import app.katyasystem.apps.databinding.DetailsScreenBinding
import app.katyasystem.apps.databinding.PackageListItemBinding
import app.katyasystem.apps.util.appDetailsIntent
import app.katyasystem.apps.util.componentName
import app.katyasystem.apps.util.getVersionNameOrVersionCode
import app.katyasystem.apps.util.isSystemPackage
import app.katyasystem.apps.util.isUpdatedSystemPackage
import app.katyasystem.apps.util.maybeSetText
import app.katyasystem.apps.util.setAvailable
