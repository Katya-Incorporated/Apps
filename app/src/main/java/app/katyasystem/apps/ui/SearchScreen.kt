...
import app.katyasystem.apps.core.PackageSource
import app.katyasystem.apps.core.mainHandler
import app.katyasystem.apps.databinding.SearchScreenBinding
import app.katyasystem.apps.util.requestKeyboard
...
class SearchScreen : PackageListFragment<SearchScreenBinding>() {
    ...
    override fun onViewsCreated(views: SearchScreenBinding, savedInstanceState: Bundle?) {
        ...
        val srcFilters = mapOf(
            views.pkgSourcekatyasystem to PackageSource.katyasystem,
            views.pkgSourceGoogle to PackageSource.Google,
            views.pkgSourcekatyasystemBuild to PackageSource.katyasystem_build,
        )
