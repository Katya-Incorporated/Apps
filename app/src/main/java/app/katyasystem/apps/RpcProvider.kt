...
import app.katyasystem.apps.autoupdate.AutoUpdatePrefs
import app.katyasystem.apps.core.InstallParams
import app.katyasystem.apps.core.PackageInstallerError
import app.katyasystem.apps.core.PackageState
import app.katyasystem.apps.core.startPackageInstall
import app.katyasystem.apps.core.pkgManager
import app.katyasystem.apps.util.getApplicationInfo
import app.katyasystem.apps.util.getSharedPreferences
import app.katyasystem.apps.util.maybeGetParcelable
import app.katyasystem.apps.util.toInt
